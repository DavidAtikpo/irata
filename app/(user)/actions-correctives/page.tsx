...
export default function ActionsCorrectivesPage() {
  ...
  const fetchActionsCorrectives = async () => {
    try {
      ...
      const response = await fetch(`/api/user/actions-correctives?${params}`);
      if (response.ok) {
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-2 text-gray-600">
                Gérez vos actions correctives assignées
              </p>
            </div>
            <Link
              href="/actions-correctives/nouvelle"
          ...
          {actionsCorrectives.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Vous n'avez aucune action corrective assignée.
              </p>
            </div>
          ) : (
                ...
                <div key={action.id} className="p-6 hover:bg-gray-50">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="mt-2">
                        <Link
                          href={`/non-conformites/${action.nonConformite.id}`}
                    ...
                    <div className="flex items-center space-x-4 ml-6">
                      ...
                      <Link
                        href={`/actions-correctives/${action.id}`}
                        className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition-colors"
                      >
                        Voir détails
                      </Link>
