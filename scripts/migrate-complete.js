...
try {
  ...
  // 6. Restaurer les APIs Prisma
  console.log('🔄 Étape 6: Restauration des APIs Prisma...');
  execSync('node scripts/restore-prisma-apis.js', { 
    cwd: path.join(process.cwd()),
    stdio: 'inherit'
  });
  ...
  console.log('✅ Toutes les APIs utilisent maintenant Prisma');
  console.log('✅ Vous pouvez supprimer les fichiers JSON si vous le souhaitez');
  console.log('');
  console.log('🚀 Redémarrez votre application pour appliquer tous les changements');
  ...
  console.log('🚀 Pour migrer quand la DB sera prête: node scripts/migrate-complete.js');
}
